...
var PhotosComponent = /** @class */ (function () {
    ...
    PhotosComponent.prototype.onFileSelected = function (event) {
        this.photoService.onFileSelected(event);
    };
    PhotosComponent.prototype.onUpload = function () {
...
var PhotoService = /** @class */ (function () {
    ...
    PhotoService.prototype.fileProgress = function (fileInput) {
    ...
    PhotoService.prototype.onFileSelected = function (event) {
        console.log(event);
        this.selectedFile = event.target.files[0];
    };
    PhotoService.prototype.onUpload = function () {
        var fd = new FormData();
        fd.append('imageURL', this.selectedFile, this.selectedFile.name);
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].URL_API + this.API, fd)
            .subscribe(function (res) {
            console.log(res);
        });
    };
