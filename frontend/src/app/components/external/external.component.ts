...
export class ExternalComponent implements OnInit {
  ...
  // Reports
  exportAsXLSX(): void {
    this.externalService.exportAsExcelFile(this.externalService.allExternal, 'Gastos-Externos');
  }
  ...
  downloadExternalPDF() {
    ...
    doc.save('Gastos-Externos-' + new Date().getTime() + '.pdf')
  }
  ...
  generateHeader(doc) {
    ...
    doc.text("Gastos Externos - SAM 13", 50, 22, { align: "center" });
  }
  generateInformation(doc) {
    var id = document.getElementById('table-external');
    doc.autoTable(
      {
        margin: {
          bottom: 60,
